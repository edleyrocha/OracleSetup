...
ExecStart=/home/oracle/scripts/oracle.sh start
ExecStop=/home/oracle/scripts/oracle.sh stop
#
# SERVICE
...
#
#/u01/app/oracle/product/11.2.0.4/db_1/shutdown.log
#/u01/app/oracle/product/11.2.0.4/db_1/startup.log
[Install]
